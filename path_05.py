...
# -*- coding: utf-8 -*-
'''
F A I L E D   Path planning in non-static environment: Kinodynamic RRT method algorithm
...
class World():
    ...
    pygame.display.set_caption('Path finding: F A I L E D   Kinodynamic RRT')
